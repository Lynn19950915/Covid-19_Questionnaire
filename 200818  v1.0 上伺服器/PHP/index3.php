...
        </div>
    ...
    <section>
        <form method="post" name="exp3" id="exp3" onsubmit="return check()" accept-charset="utf-8" style="padding: 5% 7.5%">
            ...
            <div id="progress-bar"  style="position: absolute; width:  24%; height: 100%; background-color: orange">24%</div>
            </div><br><br></div>
            
            <div id="quarantining" style="display: none">
            <div id="progress"      style="position: relative; width: 100%; height: 30px; background-color: grey">
            <div id="progress-bar"  style="position: absolute; width:  19%; height: 100%; background-color: orange">19%</div>
            </div><br><br></div>

            <div id="quarantined" style="display: none">
            <div id="progress"      style="position: relative; width: 100%; height: 30px; background-color: grey">
            <div id="progress-bar"  style="position: absolute; width:  17%; height: 100%; background-color: orange">17%</div>
            </div><br><br></div>
...
            </fieldset>
            ...
            <script>
                ...
                function C8C9(){
                    ...
                    var cA5=document.exp3.A5.value;
                ...
                function progress(){
                    ...
                    var cA5=document.exp3.A5.value;
                    var cA5_4=document.exp3.A5_4.value;
