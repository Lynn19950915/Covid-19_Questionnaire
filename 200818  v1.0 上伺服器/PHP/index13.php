...
        </div>
    ...
    <section>
        <form method="post" name="exp13" id="exp13" onsubmit="return check()" accept-charset="utf-8" style="padding: 5% 7.5%">
            ...
            <div id="progress"      style="position: relative; width: 100%; height: 30px; background-color: grey">
            <div id="progress-bar"  style="position: absolute; width:  88%; height: 100%; background-color: orange">88%</div>
            </div><br></div>
            ...
            <script>
                ...
                function check(){
                    ...
                    if(j>0){
                        ...
                        var cA5_4=document.exp13.A5_4.value;
                        
                        if(cA5_4==1){
                            document.getElementById("exp13").action="index14.php";
                        }else{
                            //分流: 隔離中者問卷到此結束
                            document.getElementById("exp13").action="index16.php";
                        }
                        document.getElementById("exp13").submit();
                    }
                }
                ...
                function progress(){
                    ...
                    var cA5=document.exp13.A5.value;
                    var cA5_4=document.exp13.A5_4.value;
