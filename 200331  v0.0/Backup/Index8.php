...
<body style="font-family: Microsoft JhengHei">
    <section>
        <form method="post" name="exp8" id="exp8" onsubmit="return check();" accept-charset="utf-8" style="padding: 1%">
            ...
            <input type=hidden name="t107" value="0">   <input type=hidden name="t108" value="0">
            <input type=hidden name="t109" value="0">   <input type=hidden name="t110" value="0">
            <input type=hidden name="t111" value="0">   <input type=hidden name="t112" value="0">
            <input type=hidden name="t113" value="0">   <input type=hidden name="t114" value="0">
            <input type=hidden name="t115" value="0">   <input type=hidden name="t116" value="0">
            <input type=hidden name="t117" value="0">   <input type=hidden name="t118" value="0">
            <input type=hidden name="t119" value="0">   <input type=hidden name="t120" value="0">
            <input type=hidden name="t121" value="0">   <input type=hidden name="t122" value="0">
            <input type=hidden name="t123" value="0">   <input type=hidden name="t124" value="0">
            <input type=hidden name="t125" value="0">   <input type=hidden name="t126" value="0">
            ...
            <fieldset data-role="controlgroup">
                <legend><div name="no8"></div><div name="item6" style="padding: 10px; font-size: 20px">我對他人的第一印象通常都是正確的。</div></legend>
                <li>
                    <label><input type="radio" name="t107" value="1">&nbsp; &nbsp;非常不同意</label>
                    <label><input type="radio" name="t107" value="2">&nbsp; &nbsp;不同意</label>
                    <label><input type="radio" name="t107" value="3">&nbsp; &nbsp;沒意見</label>
                    <label><input type="radio" name="t107" value="4">&nbsp; &nbsp;同意</label>
                    <label><input type="radio" name="t107" value="5">&nbsp; &nbsp;非常同意</label>
                </li>
            </fieldset><br>
            <fieldset data-role="controlgroup">
                <legend><div name="no8"></div><div name="item6" style="padding: 10px; font-size: 20px">對我而言，改掉任何一個壞習慣都很難。</div></legend>
                <li>
                    <label><input type="radio" name="t108" value="5">&nbsp; &nbsp;非常不同意</label>
                    <label><input type="radio" name="t108" value="4">&nbsp; &nbsp;不同意</label>
                    <label><input type="radio" name="t108" value="3">&nbsp; &nbsp;沒意見</label>
                    <label><input type="radio" name="t108" value="2">&nbsp; &nbsp;同意</label>
                    <label><input type="radio" name="t108" value="1">&nbsp; &nbsp;非常同意</label>
                </li>
            </fieldset><br>
            <fieldset data-role="controlgroup">
                <legend><div name="no8"></div><div name="item6" style="padding: 10px; font-size: 20px">我一點也不想知道別人怎麼看我。</div></legend>
                <li>
                    <label><input type="radio" name="t109" value="1">&nbsp; &nbsp;非常不同意</label>
                    <label><input type="radio" name="t109" value="2">&nbsp; &nbsp;不同意</label>
                    <label><input type="radio" name="t109" value="3">&nbsp; &nbsp;沒意見</label>
                    <label><input type="radio" name="t109" value="4">&nbsp; &nbsp;同意</label>
                    <label><input type="radio" name="t109" value="5">&nbsp; &nbsp;非常同意</label>
                </li>
            </fieldset><br>
            <fieldset data-role="controlgroup">
                <legend><div name="no8"></div><div name="item6" style="padding: 10px; font-size: 20px">我並不總是對自己誠實。</div></legend>
                <li>
                    <label><input type="radio" name="t110" value="5">&nbsp; &nbsp;非常不同意</label>
                    <label><input type="radio" name="t110" value="4">&nbsp; &nbsp;不同意</label>
                    <label><input type="radio" name="t110" value="3">&nbsp; &nbsp;沒意見</label>
                    <label><input type="radio" name="t110" value="2">&nbsp; &nbsp;同意</label>
                    <label><input type="radio" name="t110" value="1">&nbsp; &nbsp;非常同意</label>
                </li>
            </fieldset><br>
            <fieldset data-role="controlgroup">
                <legend><div name="no8"></div><div name="item6" style="padding: 10px; font-size: 20px">我總是清楚知道自己為什麼會喜歡某些東西。</div></legend>
                <li>
                    <label><input type="radio" name="t111" value="1">&nbsp; &nbsp;非常不同意</label>
                    <label><input type="radio" name="t111" value="2">&nbsp; &nbsp;不同意</label>
                    <label><input type="radio" name="t111" value="3">&nbsp; &nbsp;沒意見</label>
                    <label><input type="radio" name="t111" value="4">&nbsp; &nbsp;同意</label>
                    <label><input type="radio" name="t111" value="5">&nbsp; &nbsp;非常同意</label>
                </li>
            </fieldset><br>
            <fieldset data-role="controlgroup">
                <legend><div name="no8"></div><div name="item6" style="padding: 10px; font-size: 20px">情緒激動會使我無法冷靜思考。</div></legend>
                <li>
                    <label><input type="radio" name="t112" value="5">&nbsp; &nbsp;非常不同意</label>
                    <label><input type="radio" name="t112" value="4">&nbsp; &nbsp;不同意</label>
                    <label><input type="radio" name="t112" value="3">&nbsp; &nbsp;沒意見</label>
                    <label><input type="radio" name="t112" value="2">&nbsp; &nbsp;同意</label>
                    <label><input type="radio" name="t112" value="1">&nbsp; &nbsp;非常同意</label>
                </li>
            </fieldset><br>
            <fieldset data-role="controlgroup">
                <legend><div name="no8"></div><div name="item6" style="padding: 10px; font-size: 20px">一旦我的主意已定，別人很少能改變我。</div></legend>
                <li>
                    <label><input type="radio" name="t113" value="1">&nbsp; &nbsp;非常不同意</label>
                    <label><input type="radio" name="t113" value="2">&nbsp; &nbsp;不同意</label>
                    <label><input type="radio" name="t113" value="3">&nbsp; &nbsp;沒意見</label>
                    <label><input type="radio" name="t113" value="4">&nbsp; &nbsp;同意</label>
                    <label><input type="radio" name="t113" value="5">&nbsp; &nbsp;非常同意</label>
                </li>
            </fieldset><br>
            <fieldset data-role="controlgroup">
                <legend><div name="no8"></div><div name="item6" style="padding: 10px; font-size: 20px">當我超速駕駛時，我不是一個安全的駕駛者。</div></legend>
                <li>
                    <label><input type="radio" name="t114" value="5">&nbsp; &nbsp;非常不同意</label>
                    <label><input type="radio" name="t114" value="4">&nbsp; &nbsp;不同意</label>
                    <label><input type="radio" name="t114" value="3">&nbsp; &nbsp;沒意見</label>
                    <label><input type="radio" name="t114" value="2">&nbsp; &nbsp;同意</label>
                    <label><input type="radio" name="t114" value="1">&nbsp; &nbsp;非常同意</label>
                </li>
            </fieldset><br>
            <fieldset data-role="controlgroup">
                <legend><div name="no8"></div><div name="item6" style="padding: 10px; font-size: 20px">我完全能掌握自己的命運。</div></legend>
                <li>
                    <label><input type="radio" name="t115" value="1">&nbsp; &nbsp;非常不同意</label>
                    <label><input type="radio" name="t115" value="2">&nbsp; &nbsp;不同意</label>
                    <label><input type="radio" name="t115" value="3">&nbsp; &nbsp;沒意見</label>
                    <label><input type="radio" name="t115" value="4">&nbsp; &nbsp;同意</label>
                    <label><input type="radio" name="t115" value="5">&nbsp; &nbsp;非常同意</label>
                </li>
            </fieldset><br>
            <fieldset data-role="controlgroup">
                <legend><div name="no8"></div><div name="item6" style="padding: 10px; font-size: 20px">我很難不去想一個令我困擾的念頭。</div></legend>
                <li>
                    <label><input type="radio" name="t116" value="5">&nbsp; &nbsp;非常不同意</label>
                    <label><input type="radio" name="t116" value="4">&nbsp; &nbsp;不同意</label>
                    <label><input type="radio" name="t116" value="3">&nbsp; &nbsp;沒意見</label>
                    <label><input type="radio" name="t116" value="2">&nbsp; &nbsp;同意</label>
                    <label><input type="radio" name="t116" value="1">&nbsp; &nbsp;非常同意</label>
                </li>
            </fieldset><br>
            <fieldset data-role="controlgroup">
                <legend><div name="no8"></div><div name="item6" style="padding: 10px; font-size: 20px">一旦做出決定，我從不後悔。</div></legend>
                <li>
                    <label><input type="radio" name="t117" value="1">&nbsp; &nbsp;非常不同意</label>
                    <label><input type="radio" name="t117" value="2">&nbsp; &nbsp;不同意</label>
                    <label><input type="radio" name="t117" value="3">&nbsp; &nbsp;沒意見</label>
                    <label><input type="radio" name="t117" value="4">&nbsp; &nbsp;同意</label>
                    <label><input type="radio" name="t117" value="5">&nbsp; &nbsp;非常同意</label>
                </li>
            </fieldset><br>
            <fieldset data-role="controlgroup">
                <legend><div name="no8"></div><div name="item6" style="padding: 10px; font-size: 20px">有時，優柔寡斷使我喪失了許多機會。</div></legend>
                <li>
                    <label><input type="radio" name="t118" value="5">&nbsp; &nbsp;非常不同意</label>
                    <label><input type="radio" name="t118" value="4">&nbsp; &nbsp;不同意</label>
                    <label><input type="radio" name="t118" value="3">&nbsp; &nbsp;沒意見</label>
                    <label><input type="radio" name="t118" value="2">&nbsp; &nbsp;同意</label>
                    <label><input type="radio" name="t118" value="1">&nbsp; &nbsp;非常同意</label>
                </li>
            </fieldset><br>
            <fieldset data-role="controlgroup">
                <legend><div name="no8"></div><div name="item6" style="padding: 10px; font-size: 20px">我之所以會去投票，是因我覺得我這一票可能起到關鍵的作用。</div></legend>
                <li>
                    <label><input type="radio" name="t119" value="1">&nbsp; &nbsp;非常不同意</label>
                    <label><input type="radio" name="t119" value="2">&nbsp; &nbsp;不同意</label>
                    <label><input type="radio" name="t119" value="3">&nbsp; &nbsp;沒意見</label>
                    <label><input type="radio" name="t119" value="4">&nbsp; &nbsp;同意</label>
                    <label><input type="radio" name="t119" value="5">&nbsp; &nbsp;非常同意</label>
                </li>
            </fieldset><br>
            <fieldset data-role="controlgroup">
                <legend><div name="no8"></div><div name="item6" style="padding: 10px; font-size: 20px">當父母懲罰我時，他們並非總是有理的。</div></legend>
                <li>
                    <label><input type="radio" name="t120" value="5">&nbsp; &nbsp;非常不同意</label>
                    <label><input type="radio" name="t120" value="4">&nbsp; &nbsp;不同意</label>
                    <label><input type="radio" name="t120" value="3">&nbsp; &nbsp;沒意見</label>
                    <label><input type="radio" name="t120" value="2">&nbsp; &nbsp;同意</label>
                    <label><input type="radio" name="t120" value="1">&nbsp; &nbsp;非常同意</label>
                </li>
            </fieldset><br>
            <fieldset data-role="controlgroup">
                <legend><div name="no8"></div><div name="item6" style="padding: 10px; font-size: 20px">我是一個完全理智的人。</div></legend>
                <li>
                    <label><input type="radio" name="t121" value="1">&nbsp; &nbsp;非常不同意</label>
                    <label><input type="radio" name="t121" value="2">&nbsp; &nbsp;不同意</label>
                    <label><input type="radio" name="t121" value="3">&nbsp; &nbsp;沒意見</label>
                    <label><input type="radio" name="t121" value="4">&nbsp; &nbsp;同意</label>
                    <label><input type="radio" name="t121" value="5">&nbsp; &nbsp;非常同意</label>
                </li>
            </fieldset><br>
            <fieldset data-role="controlgroup">
                <legend><div name="no8"></div><div name="item6" style="padding: 10px; font-size: 20px">我很少接受別人的批評。</div></legend>
                <li>
                    <label><input type="radio" name="t122" value="5">&nbsp; &nbsp;非常不同意</label>
                    <label><input type="radio" name="t122" value="4">&nbsp; &nbsp;不同意</label>
                    <label><input type="radio" name="t122" value="3">&nbsp; &nbsp;沒意見</label>
                    <label><input type="radio" name="t122" value="2">&nbsp; &nbsp;同意</label>
                    <label><input type="radio" name="t122" value="1">&nbsp; &nbsp;非常同意</label>
                </li>
            </fieldset><br>
            <fieldset data-role="controlgroup">
                <legend><div name="no8"></div><div name="item6" style="padding: 10px; font-size: 20px">我對自己的判斷力很有信心。</div></legend>
                <li>
                    <label><input type="radio" name="t123" value="1">&nbsp; &nbsp;非常不同意</label>
                    <label><input type="radio" name="t123" value="2">&nbsp; &nbsp;不同意</label>
                    <label><input type="radio" name="t123" value="3">&nbsp; &nbsp;沒意見</label>
                    <label><input type="radio" name="t123" value="4">&nbsp; &nbsp;同意</label>
                    <label><input type="radio" name="t123" value="5">&nbsp; &nbsp;非常同意</label>
                </li>
            </fieldset><br>
            <fieldset data-role="controlgroup">
                <legend><div name="no8"></div><div name="item6" style="padding: 10px; font-size: 20px">有時，我懷疑自己是否有做一個戀人的能力。</div></legend>
                <li>
                    <label><input type="radio" name="t124" value="5">&nbsp; &nbsp;非常不同意</label>
                    <label><input type="radio" name="t124" value="4">&nbsp; &nbsp;不同意</label>
                    <label><input type="radio" name="t124" value="3">&nbsp; &nbsp;沒意見</label>
                    <label><input type="radio" name="t124" value="2">&nbsp; &nbsp;同意</label>
                    <label><input type="radio" name="t124" value="1">&nbsp; &nbsp;非常同意</label>
                </li>
            </fieldset><br>
            <fieldset data-role="controlgroup">
                <legend><div name="no8"></div><div name="item6" style="padding: 10px; font-size: 20px">就是有人不喜歡我，我也無所謂。</div></legend>
                <li>
                    <label><input type="radio" name="t125" value="1">&nbsp; &nbsp;非常不同意</label>
                    <label><input type="radio" name="t125" value="2">&nbsp; &nbsp;不同意</label>
                    <label><input type="radio" name="t125" value="3">&nbsp; &nbsp;沒意見</label>
                    <label><input type="radio" name="t125" value="4">&nbsp; &nbsp;同意</label>
                    <label><input type="radio" name="t125" value="5">&nbsp; &nbsp;非常同意</label>
                </li>
            </fieldset><br>
            <fieldset data-role="controlgroup">
                <legend><div name="no8"></div><div name="item6" style="padding: 10px; font-size: 20px">我並不總是知道為什麼我會如此做某些事。</div></legend>
                <li>
                    <label><input type="radio" name="t126" value="5">&nbsp; &nbsp;非常不同意</label>
                    <label><input type="radio" name="t126" value="4">&nbsp; &nbsp;不同意</label>
                    <label><input type="radio" name="t126" value="3">&nbsp; &nbsp;沒意見</label>
                    <label><input type="radio" name="t126" value="2">&nbsp; &nbsp;同意</label>
                    <label><input type="radio" name="t126" value="1">&nbsp; &nbsp;非常同意</label>
                </li>
            </fieldset><br>
            <br>
            已完成 7/8<br>
            ...
            <script>
                ...
                function gen(){
                    No=document.getElementsByName("no8");
                ...
                function highlight(){
                    var count=[], j=0;
                    items=["Time107", "Time108", "Time109", "Time110", "Time111", "Time112", "Time113", "Time114", "Time115", "Time116",
                           "Time117", "Time118", "Time119", "Time120", "Time121", "Time122", "Time123", "Time124", "Time125", "Time126"];
                    for(var i=0, iLen=items.length; i<iLen; i++){
                        if(document.getElementById(items[i]).value==0){
                            divv=document.getElementsByName("item6")[i];
